/**
 * WhatsAppManager — Baileys socket lifecycle for the web panel.
 *
 * Responsibilities:
 ...
 *
 * This is the refactored version of the old Telegram-driven manager:
 * all messaging is replaced by an EventEmitter — the web API + WebSocket
 * hub are the only consumers.
 */
const {
